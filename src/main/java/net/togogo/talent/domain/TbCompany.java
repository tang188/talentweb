...
public class TbCompany {
	...
	public String toString() {
		return "TbCompany [compId=" + compId + ", compEmail=" + compEmail + ", compPassword=" + compPassword
				+ ", compName=" + compName + ", compInfo=" + compInfo + ", compLogo=" + compLogo + ", compAddress="
				+ compAddress + ", compFocus=" + compFocus + ", compLicense=" + compLicense + ", compPhone=" + compPhone
				+ ", compState=" + compState + "]";
	}
